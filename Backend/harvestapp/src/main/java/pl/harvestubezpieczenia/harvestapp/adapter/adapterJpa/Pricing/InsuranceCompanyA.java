package pl.harvestubezpieczenia.harvestapp.adapter.adapterJpa.Pricing;
...
@Service
public class InsuranceCompanyA implements InsuranceCompanyPricing {

    private final OfferRepo offerRepo;
    private final OfferMapper offerMapper;

    @Autowired
    public InsuranceCompanyA(OfferRepo offerRepo, OfferMapper offerMapper) {
